...
function windowLoadInit() {
    ...
    //
     ...
     //                jQuery("#products").append("<li class=\"product type-product\">\n" +
     //                    "<div class=\"vertical-item content-padding text-center with_border\">\n" +
     //                    "<div class=\"item-media with_background bottommargin_30\"> <img src=\"" + products[i].image + "\" alt=\"\" /> </div>\n" +
     ...
     //                    "</a>\n" +
     //                    "<h4 class=\"entry-title\"> <a href=\"/product\">"+products[i].name+"</a> </h4>\n" +
     //                    "<p class=\"content-3lines-ellipsis\">"+products[i].description+"</p>\n" +
     ...
     //                    "</span> </div>\n" +
     //                    "<div class=\"price\"> <ins>\n" +
     //                    "<span class=\"amount\">"+products[i].price+"</span>\n" +
     //                    "</ins> </div>\n" +
     //                    "</div>\n" +
     //                    "</div>\n" +
     //                    "</div>\n" +
	...
	jQuery('#register_now').click(function() {
		if (sending) return;
        var firstNameValue = jQuery('#billing_first_name').val();
        var lastNameValue = jQuery('#billing_last_name').val();
        var companyValue = jQuery('#billing_company').val();
        var emailValue = jQuery('#billing_email').val();
        var addressValue = jQuery('#billing_address_1').val();
        var phoneValue = jQuery('#billing_phone').val();
        var passwordValue = jQuery('#billing_password').val();
        ...
        if (companyValue === null || firstNameValue.length === 0) {
